...
indcross = read_excel("indcross_8486_unrate.xlsx")
...
data$highun = with(data,ifelse(unrate>=0.03565,1,0)) #0.03565 is the median of Union rate
...
func.spline = ("tenurei+data_lj_1979+data_lj_1980+data_lj_1981+
...
output.table3[1,] = summary(lm(paste("changele~layoff1+",func.spline,sep = ""),data = data))$coefficients[2,1:4]
output.table3[2,] = summary(lm(paste("lweekl~layoff1+",func.spline,sep = ""),data = data))$coefficients[2,1:4]
output.table3[3,] = summary(lm(paste("lweekc~layoff1+",func.spline,sep = ""),data = data))$coefficients[2,1:4]
output.table3[4,] = summary(lm(paste("changele~layoff1+",func.spline,sep = ""),data = data,subset = (WWRK==1)))$coefficients[2,1:4]
output.table3[5,] = summary(lm(paste("lweekl~layoff1+",func.spline,sep = ""),data = data,subset = (WWRK==1)))$coefficients[2,1:4]
output.table3[6,] = summary(lm(paste("lweekc~layoff1+",func.spline,sep = ""),data = data,subset = (WWRK==1)))$coefficients[2,1:4]
output.table3[7,] = summary(lm(paste("changele~layoff1+",func.spline,sep = ""),data = data,subset = (WWRK==0)))$coefficients[2,1:4]
output.table3[8,] = summary(lm(paste("lweekl~layoff1+",func.spline,sep = ""),data = data,subset = (WWRK==0)))$coefficients[2,1:4]
output.table3[9,] = summary(lm(paste("lweekc~layoff1+",func.spline,sep = ""),data = data,subset = (WWRK==0)))$coefficients[2,1:4]
output.table3[10,] = summary(lm(paste("changele~layoff1+",func.spline,sep = ""),data = data,subset = (unrate<=0.04)))$coefficients[2,1:4]
output.table3[11,] = summary(lm(paste("lweekl~layoff1+",func.spline,sep = ""),data = data,subset = (unrate<=0.04)))$coefficients[2,1:4]
output.table3[12,] = summary(lm(paste("lweekc~layoff1+",func.spline,sep = ""),data = data,subset = (unrate<=0.04)))$coefficients[2,1:4]
output.table3[13,] = summary(lm(paste("changele~layoff1+",func.spline,sep = ""),data = data,subset = (unrate>0.04)))$coefficients[2,1:4]
output.table3[14,] = summary(lm(paste("lweekl~layoff1+",func.spline,sep = ""),data = data,subset = (unrate>0.04)))$coefficients[2,1:4]
output.table3[15,] = summary(lm(paste("lweekc~layoff1+",func.spline,sep = ""),data = data,subset = (unrate>0.04)))$coefficients[2,1:4]
...
output.table4[1,] = summary(lm(paste("changele~lfXlow+",func.spline,sep = ""),data = data))$coefficients[2,1:4]
output.table4[2,] = summary(lm(paste("lweekl~lfXlow+",func.spline,sep = ""),data = data))$coefficients[2,1:4]
output.table4[3,] = summary(lm(paste("lweekc~lfXlow+",func.spline,sep = ""),data = data))$coefficients[2,1:4]
output.table4[4,] = summary(lm(paste("changele~lfXhig+",func.spline,sep = ""),data = data))$coefficients[2,1:4]
output.table4[5,] = summary(lm(paste("lweekl~lfXhig+",func.spline,sep = ""),data = data))$coefficients[2,1:4]
output.table4[6,] = summary(lm(paste("lweekc~lfXhig+",func.spline,sep = ""),data = data))$coefficients[2,1:4]
output.table4[7,] = summary(lm(paste("changele~lfXlow+",func.spline,sep = ""),data = data,subset = (WWRK==1)))$coefficients[2,1:4]
output.table4[8,] = summary(lm(paste("lweekl~lfXlow+",func.spline,sep = ""),data = data,subset = (WWRK==1)))$coefficients[2,1:4]
output.table4[9,] = summary(lm(paste("lweekc~lfXlow+",func.spline,sep = ""),data = data,subset = (WWRK==1)))$coefficients[2,1:4]
output.table4[10,] = summary(lm(paste("changele~lfXhig+",func.spline,sep = ""),data = data,subset = (WWRK==1)))$coefficients[2,1:4]
output.table4[11,] = summary(lm(paste("lweekl~lfXhig+",func.spline,sep = ""),data = data,subset = (WWRK==1)))$coefficients[2,1:4]
output.table4[12,] = summary(lm(paste("lweekc~lfXhig+",func.spline,sep = ""),data = data,subset = (WWRK==1)))$coefficients[2,1:4]
output.table4[13,] = summary(lm(paste("changele~lfXlow+",func.spline,sep = ""),data = data,subset = (WWRK==0)))$coefficients[2,1:4]
output.table4[14,] = summary(lm(paste("lweekl~lfXlow+",func.spline,sep = ""),data = data,subset = (WWRK==0)))$coefficients[2,1:4]
output.table4[15,] = summary(lm(paste("lweekc~lfXlow+",func.spline,sep = ""),data = data,subset = (WWRK==0)))$coefficients[2,1:4]
output.table4[16,] = summary(lm(paste("changele~lfXhig+",func.spline,sep = ""),data = data,subset = (WWRK==0)))$coefficients[2,1:4]
output.table4[17,] = summary(lm(paste("lweekl~lfXhig+",func.spline,sep = ""),data = data,subset = (WWRK==0)))$coefficients[2,1:4]
output.table4[18,] = summary(lm(paste("lweekc~lfXhig+",func.spline,sep = ""),data = data,subset = (WWRK==0)))$coefficients[2,1:4]

##table5
data$cemp = with(data,ifelse((EMPSTAT>=10&EMPSTAT<=12),1,0))
output.table5 = data.frame(estimate=c(NA),se=c(NA),t=c(NA),p=c(NA))
output.table5[1,] = summary(lm(paste("changele~layoff1+",func.spline,sep = ""),data = data,subset = (DWLASTWRK>=2&cemp==1)))$coefficients[2,1:4]
output.table5[2,] = summary(lm(paste("lweekl~layoff1+",func.spline,sep = ""),data = data,subset = (DWLASTWRK>=2&cemp==1)))$coefficients[2,1:4]
output.table5[3,] = summary(lm(paste("lweekc~layoff1+",func.spline,sep = ""),data = data,subset = (DWLASTWRK>=2&cemp==1)))$coefficients[2,1:4]
output.table5[4,] = summary(lm(paste("changele~layoff1+",func.spline,sep = ""),data = data,subset = (DWLASTWRK>=2&cemp==1&WWRK==1)))$coefficients[2,1:4]
...
output.table5[6,] = summary(lm(paste("lweekc~layoff1+",func.spline,sep = ""),data = data,subset = (DWLASTWRK>=2&cemp==1&WWRK==1)))$coefficients[2,1:4]
output.table5[7,] = summary(lm(paste("changele~layoff1+",func.spline,sep = ""),data = data,subset = (DWLASTWRK>=2&cemp==1&WWRK==0)))$coefficients[2,1:4]
...
output.table5[9,] = summary(lm(paste("lweekc~layoff1+",func.spline,sep = ""),data = data,subset = (DWLASTWRK>=2&cemp==1&WWRK==0)))$coefficients[2,1:4]
